                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="barang">
                            <ul class="nav nav-collapse">
                                <li><a href="{{ route('barang.index') }}"><span class="sub-item">Data Barang</span></a>
                                </li>
                    ...
                    @if (in_array($role, ['admin', 'superadmin']))
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="penjualan">
                                <ul class="nav nav-collapse">
                                    <li><a href="{{ route('penjualan.index') }}"><span class="sub-item">Riwayat
                                                Transaksi
                                                Penjualan</span></a></li>
                                    <li><a href="{{ route('penjualan.create') }}"><span class="sub-item">Tambah Nota
                                                Penjualan</span></a></li>
                                    <li><a href="{{ route('pembayaran_penjualan.index') }}"><span
                                                class="sub-item">Riwayat
                    ...
                    @if ($role === 'superadmin')
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="pembelian">
                                <ul class="nav nav-collapse">
                                    <li><a href="{{ route('pembelian.index') }}"><span class="sub-item">Riwayat
                                                Transaksi
                                                Pembelian</span></a></li>
