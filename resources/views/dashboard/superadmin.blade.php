    ...
    <div class="container">
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    <h3 class="fw-bold mb-3">Dashboard Superadmin</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Top 5 Barang Terlaris</div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="card-title">User Berdasarkan Role</div>
                        </div>
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">Manager <span class="float-end">{{ $userPerRole['manager'] }}</span></li>
                                <li class="list-group-item">Admin <span class="float-end">{{ $userPerRole['admin'] }}</span></li>
                                <li class="list-group-item">Sales <span class="float-end">{{ $userPerRole['sales'] }}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
